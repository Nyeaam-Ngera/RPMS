...
$query = "SELECT * FROM tcotratingsheet";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
          <h5 id="exampleModalLabel"><strong>Add Criteria for Teacher</strong></h5>
      </div>
            ...
            <form action="processindicator.php" class="form-group" method="POST">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" name="Criteria" required /> 
                        </div>
                    </div>
                    <div>
                            <button type="submit" class="btn-sm btn-primary my-4" name="tcriteriasave">Save</button>
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <form action="tcotrating_edit.php" method="post">
                            <input type="hidden" name="tCriteriaID" value ="<?php echo $row['tCriteriaID']?>">
                            <th>
                                <center>
                                    <a class="btn-sm btn-success my-4" href="tcotrating_edit.php?tcriteriaupdate=<?php echo $row['tCriteriaID'];?>">Edit</a>
             
                        </form>
                                    <a class="btn-sm btn-danger my-4" onclick="return confirm('Delete Record?'); "href="processindicator.php?tcriteriadelete=<?php echo $row['tCriteriaID'];?>">Delete</a>
                                <center>
