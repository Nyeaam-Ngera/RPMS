...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2019 at 10:54 PM
...
--
ALTER TABLE `mtindicator_tbl`
  MODIFY `indicator_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tindicator_tbl`
  MODIFY `indicator_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
COMMIT;
