...
<tbody class = "text-justify">
            ...
            <td><a href="updatepmcf.php?edit=<?php echo $row['pmcf_id'];?>" class="btn-sm btn-outline-primary text-decoration-none">Update</a></td>
            <td><a href="deletepmcf.php?delete=<?php echo $row['pmcf_id'];?>" class="btn-sm btn-outline-danger text-decoration-none" >Delete</a></td>
                </tr> 
                </tbody> 
            <!-- END LOOP FOR PMCF -->
            <?php endwhile ?>               
